...
class Server {
  ...
  func start() {
    ...
    while (true) {
      let MTU = 65536
      var addr = sockaddr(sa_len: <#T##__uint8_t#>,
                          sa_family: <#T##sa_family_t#>,
                          sa_data: <#T##(CChar, CChar, CChar, CChar, CChar, CChar, CChar, CChar, CChar, CChar, CChar, CChar, CChar, CChar)#>)
